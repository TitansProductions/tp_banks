...
1. Fixed an issue related to bank robberies, the cooldown duration that we previously fixed, could cause a numeric error sometimes, now we make sure the numeric is always valid.
