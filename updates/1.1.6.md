...
1. Added new API functions that will be used for **TP Companies** - those API functions can also be used by other developers.
2. Fixed an issue related to bank robberies, the cooldown duration was not working and the only way fixing it was by using the command.
