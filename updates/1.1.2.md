...
1. Fixed a mistake that i had made when not having TP Containers, it would not allow to buy a vault - This script does support Framework Inventory.
2. Improved a client-side task.

## Modified Files:

- client/tp-client_main.lua
- server/tp-server_account_management.lua
- fxmanifest.lua
